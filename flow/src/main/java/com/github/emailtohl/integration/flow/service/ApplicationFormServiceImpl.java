...
import com.github.emailtohl.integration.common.jpa.jpaCriterionQuery.Criterion;
...
public class ApplicationFormServiceImpl implements ApplicationFormService {
	...
	@Override
	public Long application(String email, String name, String description) {
		User u = userRepository.findByEmail(email);
		if (u == null) {
			throw new IllegalArgumentException("系统不存在此用户：" + email);
		}
	...
	@Override
	public Page<ApplicationForm> findApplicationFormByEmail(String email, Pageable pageable) {
		return applicationFormRepository.findByApplicantEmailLike(email, pageable);
	}

	@Override
	public void transit(String email, Long id, Status status, String cause) {
