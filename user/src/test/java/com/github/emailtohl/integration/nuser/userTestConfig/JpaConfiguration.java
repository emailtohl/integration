...
@EnableJpaRepositories(basePackages = "com.github.emailtohl.integration.nuser.dao", 
...
class JpaConfiguration {
	public static final String[] ENTITIES_PACKAGE = {"com.github.emailtohl.integration.nuser.entities"};
