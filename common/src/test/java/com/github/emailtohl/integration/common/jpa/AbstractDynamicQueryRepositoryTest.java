...
import com.github.emailtohl.integration.common.jpa.AbstractDynamicQueryRepository.JpqlAndArgs;
import com.github.emailtohl.integration.common.jpa.AbstractDynamicQueryRepository.PredicateAndArgs;
import com.github.emailtohl.integration.common.jpa.testEntities.Relation1;
import com.github.emailtohl.integration.common.jpa.testEntities.Relation2;
import com.github.emailtohl.integration.common.jpa.testRepository.RoleRepository;
import com.github.emailtohl.integration.common.jpa.testRepository.TestRelationRepository;
...
public class AbstractDynamicQueryRepositoryTest {
	...
	ConcreteRepository concrete;
	TestUser u;
	Role role_admin, role_employee, role_user;
	
	@Before
	public void setUp() throws Exception {
		concrete = new ConcreteRepository();
	...
	static class ConcreteRepository extends AbstractDynamicQueryRepository<User> {
