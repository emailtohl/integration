...
public class AuditCtrl {
	...
	public List<RevTuple<Role>> getRoleRevision(@PathVariable("id") Long id) {
	...
	public List<RevTuple<Customer>> getCustomerRevision(@PathVariable("id") Long id) {
	...
	public List<RevTuple<Employee>> getEmployeeRevision(@PathVariable("id") Long id) {
