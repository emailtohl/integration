...
public class CustomerCtrl extends RestCtrl<Customer> {
	...
	@RequestMapping(value = "exist/{cellPhoneOrEmail:.+}", method = RequestMethod.GET)
	public String exist(@PathVariable("cellPhoneOrEmail") String cellPhoneOrEmail) {
	...
	public ResponseEntity<Customer> getByCellPhoneOrEmail(@PathVariable("cellPhoneOrEmail") String cellPhoneOrEmail) {
		Customer c = customerService.findByCellPhoneOrEmail(cellPhoneOrEmail);
		if (c == null) {
