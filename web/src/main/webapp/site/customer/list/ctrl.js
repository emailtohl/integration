define(['customer/module', 'toastr', 'customer/service'], function(customerModule, toastr) {
	return customerModule
		.controller('CustomerList', ['$scope', '$http', '$state', 'customerService', function($scope, $http, $state, service) {
			var self = this;
