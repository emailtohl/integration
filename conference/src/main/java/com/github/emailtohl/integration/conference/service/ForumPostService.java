...
public interface ForumPostService {
	 ...
	 * @return
	 */
	_Page<SearchResult<ForumPostDto>> search(String query, Pageable pageable);
	 ...
	 * @return
	 */
	_Page<ForumPostDto> findAllAndPaging(String query, Pageable pageable);
	 ...
	 * @return 只返回查找到的实体类E
	 */
	_Page<ForumPostDto> find(String query, Pageable pageable);
	 ...
	 * @return
	 */
	_Page<ForumPostDto> getPage(Pageable pageable);
